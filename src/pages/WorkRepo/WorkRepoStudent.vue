    ...
    <div class="work-shop">
      <div class="work-shop-info clear fs-13 TH-f-c-default">
        <p class="work-shop-info-left fl">
          ...
          <span @click="handleDrop('orderType',2)" :class="{'TH-f-c-link': searchOption.orderType==2}" class="work-shop-info-item cp">评分 </span>
          <span @click="handleDrop('orderType',3)" :class="{'TH-f-c-link': searchOption.orderType==3}" class="work-shop-info-item cp">预览 </span>
          <span @click="handleDrop('orderType',4)" :class="{'TH-f-c-link': searchOption.orderType==4}" class="work-shop-info-item cp">下载 </span>
        </p>
      ...
      <div class="work-shop-list">
        ...
        <div class="cmwl-item TH-card inline-block" v-for="item in wList" @click="worksItemOpen(item)">
          ...
          <div class="cmwl-item-right fl TH-f-c-default">
            ...
            <p class="cmwl-item-right-author fs-14">{{item.categoryName}} <span class="fr TH-f-c-link">{{item.username}}</span></p>
          </div>
          ...
          <div v-if="item.excellentInAll==3 ||item.excellentInAll==4||item.excellentInAll==5" class="cmwl-item-flag relative" >
            <img class="absolute cmwl-item-flag-icon" src="~assets/imgs/classTask/school-good-work.png" alt="gw" title="学校优秀">
          </div>
