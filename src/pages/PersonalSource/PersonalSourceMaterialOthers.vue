...
<template>
  <div class="container">
    <div class="work-temp-top clear">
      ...
      <div class="work-temp-top-right fr TH-button-primary cp" @click="$router.push('/personalSource/materialOthers/upload')">
        <img class="paper-top-button-icon" src="~assets/imgs/classTask/publish-task.png" alt="air">
        <span class="fs-20">上传素材</span>
      </div>
    </div>
    ...
    <div class="work-temp-list">
      <div class="TF-temp-Arr-space" v-if="coursewareList==''">
        <img src="~assets/imgs/codeZero/coll/no-other-resources.png" alt="">
        <p class="fs-18 TH-f-c-default">没有你需要的素材呢！</p>
      </div>
